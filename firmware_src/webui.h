...
void handleRoot() {
  ...
  webServer.sendContent(
    ...
    "</select></div>"
    "</div>"
    "<div id='cpts' style='display:grid;grid-template-columns:1fr;gap:12px;margin-top:12px'>"
    // Punkt 1
    "<div>"
    "<p id='cp1h' style='display:none;font-size:.72rem;font-weight:600;color:var(--sub);text-transform:uppercase;letter-spacing:.06em' data-i18n='cal_p1'>Punkt 1</p>"
    ...
    "</div></div>"
    // Punkt 2 (nur im Widerstands-/Zwei-Punkt-Modus)
